package com.minatogithub.secrettesting1;
...
@SpringBootApplication(scanBasePackages = {"com.vs.rappit","com.vs","com.minatogithub.secrettesting1"})
@EnableCaching
...
public class SecretTesting1Application {

	public static void main(String[] args) {
		SpringApplication.run(SecretTesting1Application.class, args);
	}
